...
import 'package:luckynumbers/c_dashboard_screen/application/copy_referal_code.dart';
import 'package:luckynumbers/c_dashboard_screen/presentation/Referalhistory.dart';
import 'package:luckynumbers/c_dashboard_screen/presentation/referslider.dart';
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  DottedBorder(
                    ...
                    child: SizedBox(
                      ...
                      child: Center(
                        child: Text(
                          map['codes'] == ''?
                          'your mobile number' : map['codes'].toString(),
                  ...
                  Container(
                    ...
                    child: IconButton(
                      onPressed: () {
                        copyToClipboard(map['codes'].toString(), context);
                      },
                      icon: const Icon(
                        Icons.copy_rounded,
            ...
            Center(child: CustomButton(onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>refferalhistory()));
