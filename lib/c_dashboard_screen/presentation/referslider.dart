...
class referslider extends StatefulWidget {
  const referslider({Key? key}) : super(key: key);

  @override
  State<referslider> createState() => _refersliderState();
}

class _refersliderState extends State<referslider> {
  ...
  Future<String> state() async {
    final res = await http.get(
        Uri.parse(Apiconst.referslider)
    );
